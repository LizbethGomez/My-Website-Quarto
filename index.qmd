...
```{r}
#| output: false
file.copy("files/Gomez_CV042026.pdf", "docs/files/Gomez_CV042026.pdf", overwrite = TRUE)
```
...
::: {.home-page-links}
[Research](/research.qmd) &ensp;[Publications](/publications.qmd) &ensp;[CV](/files/Gomez_CV042026.pdf){target="_blank"}
:::
